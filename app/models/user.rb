class User < ApplicationRecord
  ...
  def add_to_mailchimp_list
    ...
    subscribe = gibbon.lists(list_id).members(Digest::MD5.hexdigest(self.email)).upsert(body: { email_address: self.email, status: "subscribed", merge_fields: {FNAME: self.first_name, LNAME: self.last_name},double_optin: true })
  end
